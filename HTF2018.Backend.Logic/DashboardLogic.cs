        ...
        public async Task<TeamStatus> GetTeamStatus(Guid teamId)
        {
            ...
            if (team != null)
            {
                return new TeamStatus
                {
                    TeamId = teamId,
                    TeamName = team.Name,
                    Challenge01Status = await GetChallengeStatus(teamId, Identifier.Challenge01),
                    Challenge02Status = await GetChallengeStatus(teamId, Identifier.Challenge02),
                    Challenge03Status = await GetChallengeStatus(teamId, Identifier.Challenge03),
                    Challenge04Status = await GetChallengeStatus(teamId, Identifier.Challenge04),
                    Challenge05Status = await GetChallengeStatus(teamId, Identifier.Challenge05),
                    Challenge06Status = await GetChallengeStatus(teamId, Identifier.Challenge06),
                    Challenge07Status = await GetChallengeStatus(teamId, Identifier.Challenge07),
                    Challenge08Status = await GetChallengeStatus(teamId, Identifier.Challenge08),
                    Challenge09Status = await GetChallengeStatus(teamId, Identifier.Challenge09),
                    Challenge10Status = await GetChallengeStatus(teamId, Identifier.Challenge10),
                    Challenge11Status = await GetChallengeStatus(teamId, Identifier.Challenge11),
                    Challenge12Status = await GetChallengeStatus(teamId, Identifier.Challenge12),
                    Challenge13Status = await GetChallengeStatus(teamId, Identifier.Challenge13),
                    Challenge14Status = await GetChallengeStatus(teamId, Identifier.Challenge14),
                    Challenge15Status = await GetChallengeStatus(teamId, Identifier.Challenge15),
                    Challenge16Status = await GetChallengeStatus(teamId, Identifier.Challenge16),
                    Challenge17Status = await GetChallengeStatus(teamId, Identifier.Challenge17),
                    Challenge18Status = await GetChallengeStatus(teamId, Identifier.Challenge18),
                    Challenge19Status = await GetChallengeStatus(teamId, Identifier.Challenge19),
                    Challenge20Status = await GetChallengeStatus(teamId, Identifier.Challenge20),
                };
            }
